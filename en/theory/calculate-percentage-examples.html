...
<html lang="en">
<head>
        <title>Calculate percentages (theory and examples)</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1, user-scalable=no">
        <meta name="description" content="We explain what percentages are, how to calculate them, and provide some examples. Example. Percentages. So much percent. Math. Calculate Percentage - Free and easy-to-use online percentage calculator. Calculate increases, decreases and percentages of a number. Fast and accurate tool for students, professionals and anyone who needs to calculate percentages.">
...
<div class="card" style="padding-top: 80px;">
  <div class="card-body" align="center">
    <h1 class="card-title" style="font-size: 1.4rem"><b>Calculate percentages (theory and examples)</b></h1>
    <h6 class="card-text" align="center" style="font-size: 0.9rem;">We explain what percentages are, how to calculate them, and provide some examples.</h6>
