...
<html lang="es">
<head>
        <title>Calcular porcentajes (teoría y ejemplos)</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1, user-scalable=no">
        <meta name="description" content="Explicamos qué son los porcentajes, cómo calcularlos y proporcionamos algunos ejemplos. Ejemplo. Porcentajes. Tanto por ciento. Matemáticas. Calcular porcentaje - Calculadora de porcentajes online gratuita y fácil de usar. Calcula aumentos, disminuciones y porcentajes de un número. Herramienta rápida y precisa para estudiantes, profesionales y cualquier persona que necesite calcular porcentajes.">
...
<div class="card" style="padding-top: 80px;">
  <div class="card-body" align="center">
    <h1 class="card-title" style="font-size: 1.4rem"><b>Calcular porcentajes (teoría y ejemplos)</b></h1>
    <h6 class="card-text" align="center" style="font-size: 0.9rem;">Explicamos qué son los porcentajes, cómo calcularlos y proporcionamos algunos ejemplos.</h6>
