...
<html lang="es">
    <head>
        <title>Calcular Porcentaje | Calculadora de Porcentajes - Tics</title>
...
<div class="card">
  <div class="card-body" align="center">
    <h1 class="card-title" style="font-size: 1.6rem">Calcular Porcentaje Online | Calculadoras de porcentajes</h1>
    <h2 class="card-text" style="font-size:1.1rem;">Estas sencillas calculadoras de porcentajes resuelven todos tus problemas</h2>
    <div class="adsanuncio" align="center"><?php include 'includes/cabecera-google-ads.php'; ?></div>
  </div>
</div>
</header>
<div class="anchormax" id="contd">   
<div class="row" >
  <div class="col-md-5">
    <!-- basica -->
    <div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-basico.png" class="card-img-top" alt="">
  <div class="card-body">
...
<!-- end basica -->
    ...
    <div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-desc.png" class="card-img-top" alt="">
  <div class="card-body">
...
<!-- end basica descuento-->
   ...
   <div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-incre.png" class="card-img-top" alt="">
  <div class="card-body">
...
<!-- end basica aumento-->
 ...
 <div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-sum-rest.png" class="card-img-top" alt="">
  <div class="card-body">
  ...
  <div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-cambio.png" class="card-img-top" alt="">
  <div class="card-body">
...
<div class="card-header" style="background-color: black; color:white;">
  <h1 class="card-title card-img-top mt-4 mb-4" align="center" style="font-size: 1.5rem;">Te podría interesar ...</h1>
</div>
  <div class="card-body">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-increm.png" class="card-img-top" alt="">
  <div class="card-body">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-dism.png" class="card-img-top" alt="">
  <div class="card-body">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-error.png" class="card-img-top" alt="">
  <div class="card-body">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <img src="includes/img/logo-pocen-otras.png" class="card-img-top" alt="">
  <div class="card-body">
...
<footer align="center" class="mt-5">
    <h1 style="font-size: 1.3rem" >Calcular Porcentaje Online Gratis - Calculadora de Porcentajes Online Gratis - Calcular Porcentaje - Calculadora de Porcentajes - Calcular Porcentajes - Calculadoras de Porcentajes</h1>
