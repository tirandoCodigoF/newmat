...
<html lang="es">
    <head>
        <title>Calculadora de Porcentajes Online</title>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1, user-scalable=no">
        <meta name="description" content="Calcular Porcentaje. Encontrarás las calculadoras de porcentajes más utilizadas. También encontrarás calculadoras más específicas que muestran el cálculo de descuentos, desviaciones porcentuales y muestran la conversión de porcentajes a decimales o fracciones. Estas sencillas calculadoras de porcentajes resuelven todos tus problemas.">
        <meta name="keywords" content="calcular, calculadora, porcentaje, porcentajes, calcular el porcentaje, calcular porcentaje, matematicas, algebra">
...
<div class="card">
  <div class="card-body" align="center">
    <h4 class="card-title">Calcular Porcentajes</h4>
    <h6 class="card-text">Estas sencillas calculadoras de porcentajes resuelven todos tus problemas</h6>
  </div>
</div>
    </header> -->
<div class="container" id="contd" style="width: 100%;max-width:98%;">   
<div class="row">
    <!-- basica -->
    <div class="col-md-6">
    <div class="mt-3 mb-3">
  ...
  <h6 class="card-title card-img-top" align="center">Calculadora básica de porcentajes</h6>
  </div>
  <div class="card-body">
  <h6 class="card-title">Calculo de porcentajes basicos</h6>
    <p class="card-text">
        <div class="row">
         <div class="col-md-6">
 ...
 <div class="mt-3 mb-3">
    <div class="card mb-3">
    <div class="card-header" style="background-color: black; color:white;">
  <h6 class="card-title card-img-top" align="center">Calculadora de incremento y dismunición de porcentajes</h6>
  </div>
  <div class="card-body">
  <h6 class="card-title">Calculo de suma y resta de porcentajes</h6>
    <p class="card-text">
        <div class="row">
         <div class="col-md-4">
    ...
    <p class="card-text" id="formula2" style="display: none;">
        <small>
        2. Suma o resta de porcentajes <br>
        P= Indica el porcentaje.<br>
        V= Indica el valor al cual le calculamos el porcentaje.<br>
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <div class="card-header" style="background-color: black; color:white;">
  <h6 class="card-title card-img-top" align="center">Calculadora de cambio porcentual</h6>
  </div>
  <div class="card-body">
    <h6 class="card-title">Cambio porcentual entre dos valores</h6>
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <div class="card-header" style="background-color: black; color:white;">
  <h6 class="card-title card-img-top" align="center">Calculadora de error porcentual</h6>
  </div>
  <div class="card-body">
    <h6 class="card-title">Error porcentual entre un valor medido y un valor teórico</h6>
    <p class="card-text">
        <div class="row">
         <div class="col-md-6">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <div class="card-header" style="background-color: black; color:white;">
  <h6 class="card-title card-img-top" align="center">¿V es el P de cuál número?</h6>
  </div>
  <div class="card-body">    
    <p class="card-text">
        <div class="row">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <div class="card-header" style="background-color: black; color:white;">
  <h6 class="card-title card-img-top" align="center">¿Qué porcentaje de V2 es V1?</h6>
  </div>
  <div class="card-body">
    <p class="card-text">
        <div class="row">
...
<div class="mt-3 mb-3">
    <div class="card mb-3">
  <div class="card-header" style="background-color: black; color:white;">
  <h6 class="card-title card-img-top" align="center">¿Qué porcentaje del número V2 es el número V1?</h6>
  </div>
  <div class="card-body">
    <p class="card-text">
        <div class="row">
...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Definición y Concepto de Porcentaje</h5>
    <p class="card-text">
...
<br>
    ...
    <h5 class="card-title">¿Cómo calcular el porcentaje?</h5>
    <p class="card-text">
...
<div class="card">
  ...
  <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
    ...
    <h5 class="card-title">8.- Conversión de porcentajes en cifras decimales o fracciones</h5>
    <p class="card-text">
    ...
    <h5 class="card-title mt-2">9.- Cálculo de descuentos</h5>
    <p class="card-text">
    ...
    <h5 class="card-title mt-2">10.- Ejemplos en tu vida diaria</h5>
    <p class="card-text">
    <h5 class="card-title mt-2">a. Impuesto a los ingresos brutos</h5>
...
<h5 class="card-title mt-2">b. Vale de descuento para una determinada cantidad</h5>
...
<h5 class="card-title mt-2">c. Cupón de descuento de un determinado porcentaje</h5>
...
<h5 class="card-title mt-2">d. Cálculo de propinas</h5>
...
<h5 class="card-title mt-2">e. Interés de un bono</h5>
...
<h5 class="card-title mt-2">f. Incremento porcentual en una cuenta de ahorros</h5>
...
<h5 class="card-title mt-2">g. Disminución porcentual después de una reducción de precios</h5>
...
<h5 class="card-title mt-2">h. Diferencia entre valores medidos y valores teóricos</h5>
...
<h5 class="card-title mt-2">i. Desviación después del redondeo</h5>
...
<footer align="center" class="mt-2">
    <h6>Calcular Porcentaje Gratis | Calculadora de Porcentajes Gratis</h6>
</footer>
